(function(){
  ...
  function ensureUi(){
    ...
    if(invoicesNav&&!$('[data-build10-finance-nav]'))invoicesNav.insertAdjacentHTML('afterend','<button class="nav-item" data-view="finance" data-build10-finance-nav type="button"><svg><use href="#i-finance"/></svg><span>Finanzcockpit</span></button>');
